          ...
          <div className="navbar-brand navbar-brand-autodark d-flex align-items-center">
            ...
            <div>
              <div className="d-sm-none">
                ...
                <div className="text-muted" style={{ fontSize: '0.75rem' }}>v2.1</div>
              </div>
              <div className="d-none d-sm-block d-md-none">
                <h1 className="h3 mb-0 fw-bold">PESKAS</h1>
                <div className="text-muted" style={{ fontSize: '0.75rem' }}>Portal v2.1</div>
              </div>
              <div className="d-none d-md-block">
                <h1 className="h2 mb-0 fw-bold">PESKAS</h1>
                <div className="h4 text-muted mb-0">Fishers Tracking Portal <span style={{ fontSize: '0.75rem' }}>v2.1</span></div>
              </div>
            </div>
          </div>
